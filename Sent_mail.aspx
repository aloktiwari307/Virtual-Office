<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminmaster.Master" AutoEventWireup="true" CodeBehind="Sent_mail.aspx.cs" Inherits="Virtual_Office_Project.admin.Sent_mail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
                        <asp:Button ID="inbox" class="btn btn-primary" OnClick="inbox_Click"  runat="server" Text="Inbox" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
